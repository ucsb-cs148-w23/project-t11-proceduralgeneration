...
+1. (Christine) posted in Python channel about Flask & Http errors <br>
+2. (Matthew) posted in js-node-react-express about Firebase Authentication <br>
+3. (Andy) posted in unity channel about Compute Shader <br>
